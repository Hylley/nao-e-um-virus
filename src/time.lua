...
function module.tick(delta)
	...
	head.seconds = head.seconds - delta * multiplier
...
function module.stop()     paused = true   end
function module.resume()   paused = false  end
function module.forward()  multiplier = 10 end
function module.backward() multiplier = 1  end
