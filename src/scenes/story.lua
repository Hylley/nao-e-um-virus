...
function story.begin()
	...
	time.schedule(function () send_as_system('sincronizando dados...') end, 33)
...
function story.first_interaction()
	...
	time.schedule(function () send_as_hacker('Tava na cara que aquilo era um vírus') end, time.after(1))
